...
const PostCard = ({img, postId, userId, cover, name, isProfile, date, isMinified}) => {
	...
	return (
		<View style={[styles.container, cardStyles]}>
			...
			<ImageBackground source={cover ? {uri: cover} : PostImg}
							 style={[styles.containerBackground, {height: isMinified ? '100%' : 400}]}>
